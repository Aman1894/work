...
/* I2C peripheral clock is set to 2MHz */
#define I2C_CLK_DIVIDER     (6)

/* 100KHz I2C bit-rate - going too fast may prevent the slave from responding in time */
...
ALIGN(16) static DMA_CHDESC_T dmaI2CDesc;
...
void I2C0_IRQHandler(void)
{
	...
	if (state & I2C_INTENSET_MSTPENDING) {
		...
		if (i2cmXferRec.status == I2CM_STATUS_OK) {
			Chip_I2C_DisableInt(LPC_I2C0, I2C_INTENSET_MSTPENDING);
		}
	}
